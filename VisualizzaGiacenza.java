...
public class VisualizzaGiacenza extends JFrame implements ActionListener {
    ...
    public VisualizzaGiacenza(Utente utente, int idMagazzino) {
        this.utente = utente;
        ...
        try {
            ...
            String query = "SELECT * FROM Prodotti WHERE luogo_di_conservazione = ?";
        ...
        this.setTitle("VisualizzaGiacenza");
